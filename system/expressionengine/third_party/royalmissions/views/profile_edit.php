<?=form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=royalmissions'.AMP.'method=save_profile');?>
...
<p><a class="rule_delete_warning" href="<?=BASE.AMP.'C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=royalmissions'.AMP.'method='.AMP.'id='.$this->input->post('id')?>"><?=lang('delete_rule')?></a> </p>
